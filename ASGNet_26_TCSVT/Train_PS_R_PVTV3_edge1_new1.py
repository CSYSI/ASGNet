...
from lib.Network_PVTV3_PS_edge_1_new import Network
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str,default='./Network_PVTv2b3/', help='the path to save model and log')
    ...
    cosine_schedule = optim.lr_scheduler.CosineAnnealingLR(optimizer=optimizer, T_max=20, eta_min=1e-7)
    print("Start train...")
